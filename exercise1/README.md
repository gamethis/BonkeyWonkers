...
### 2.1 Analyze Migration Requirements

Examine the current resource structure and identify which resource needs to be moved.

**Task**: Move the `file2` resource from [module1](../modules/module1/) to
[module2](../modules/module2/).

**Critical Requirement**: The migration must NOT recreate any files or destroy
existing resources.
...
**Expected Result**: Resource is moved between modules without any file
recreation or data loss.

## Step 3: Validation and Verification

### 3.1 Verify Final State Consistency
